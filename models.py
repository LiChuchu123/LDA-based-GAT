...
class gGATLDA(torch.nn.Module):
    ...
    def __init__(self, in_features, gconv=GATConv, latent_dim=[16, 16, 16, 16], side_features=False, n_side_features=0):
        ...
        self.conv1=GCNConv((in_features), 8)
        self.convs.append(gconv(8, 8,heads=8,dropout=0.2))
        self.convs.append(gconv(8*8, 8,heads=8,dropout=0.2))
        self.convs.append(gconv(8*8, 8,heads=8,dropout=0.2))
        self.convs.append(gconv(8*8, 2,heads=1,dropout=0.2))
